...
class UpdateVehicleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
           ...
           'rear_image' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,svg', 'max:2048'],
           'passenger_side_image' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,svg', 'max:2048'],
           'dashboard_image' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,svg', 'max:2048'],
